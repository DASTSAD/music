...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%     
    ...
    \repeat volta 2 { %begin repeated section
        ...
        %1-4 A
\mark #1 %\mark {A}
        g'4-3 g4-3( a32-4 g-3 a8-4  ) b16-5
        
        a8-4  g16-3( fs16-2)  e16-1( d8.-\finger \markup \tied-lyric #"2~5")~ d4-5 \break
        
        g,32-3( fs-2 g8.-3) a32([-4 g-3 fs-2 g-3 a16-4 g8.-3]) fs16-2 g16-3 \noBreak
        
        a32-4[( g32-3 fs16-2) g32(-4 fs32-3 e16-2)] e8(-2 d4.-1) \break \noPageBreak

%         
%       %5-8 B 
\mark #2
        d'4-5 d4-2( e32^3 d^2 e8^3) f16^4 \noBreak
        e8^3  d16(^2 c16^1)  b8(^2  a4^1)  g'32^4 fs^3 e^2 fs^3 \break 
        g32[(^4 fs16.)^3 a32(^5 g16.)]^4 fs32[(^3 e16.)^2 d32(^1 c16.)]^2  c16(^1 a'8^5 c,16^1) \noBreak
        b32[(^3 g16.)^2 fs8]^3 fs8^(^3 {g32^4) fs32-3 g16-4~ g4} \break \pageBreak
...
%       \clef treble
%       \key g \major
%         {\stemUp g,64~_1 <g~ b~_2> <g~ b~ e~_4> <g~ b~ e~ g~_5> <g b e g>8.} \stemDown a'32^4 g^3 fs^2 g a g a g a g a g fs16^2 g16^4
%     }
  >>
        g8^5  fs16^4 e16^3  d8^2 cs4^1 e8^2 \break
...
\mark #4
        ...
        cs16^3^( d16)^~[^4 d32 e32^5 d32^4 cs32]^3 cs8^3 d4.^4 \pageBreak
        %d32 cs d8.- d8
...
\mark #5
       ...
       a8.^3( fs16^2) e8^1( ds4^2) b8^1 \break
% 
%      %21-24 F
\mark #6
...
\mark #7
       ...
       c16^3 d16^4 c16^3 b16^2 c16^3 a16^2 fs16_1 a16^2 c16^3 e16^5 d16^4 c16^5 \break
%
%      %28-32 H
\mark #8 %\stemNeutral
       ...
       g4^4^~ g16 d16^2 g16^3 fs16^2 fs8^2( g8^3)\fermata
...
%     %29-32 H
    ...
    g4.^1 d8^2 \stemUp \once \override Script.padding = #.8 g,4^5_\fermata
}    
...
\score {
    ...
    \context PianoStaff <<
        ...
        \context Staff = "upper" { 
          \clef treble \key g \major \time 3/4 << \soprano >>  
        }
        \context Staff = "lower"  { 
          \clef bass \key g \major \time 3/4 \bass 
        }
    >>
    \layout{  }
    \midi { \tempo 4=40}
